...
HEADERS_FOLDER="${QPLAYER_FFMPEG_FOLDER}/include/libavutil"
...
cp -f ${BUILD_DIR}/Debug-iphoneos/libavutil.a ${LIB_FOLDER}/

cp -f ${BUILD_DIR}/Debug-iphoneos/include/avutil/* ${HEADERS_FOLDER}/

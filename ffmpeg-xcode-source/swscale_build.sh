...
HEADERS_FOLDER="${QPLAYER_FFMPEG_FOLDER}/include/libswscale"
...
cp -f ${BUILD_DIR}/Debug-iphoneos/libswscale.a ${LIB_FOLDER}/

cp -f ${BUILD_DIR}/Debug-iphoneos/include/swscale/* ${HEADERS_FOLDER}/

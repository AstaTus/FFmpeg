...
#define FFMPEG_CONFIGURATION "--target-os=darwin --arch=arm64 --cc='xcrun -sdk iphoneos clang' --enable-static --disable-shared --disable-small --disable-everything --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-avfilter --disable-avdevice --disable-nonfree --enable-swscale --disable-avfilter --disable-encoders --enable-protocol=crypto --enable-protocol=http --enable-protocol=https --enable-protocol=rtmp --enable-protocol=tcp --enable-protocol=file --enable-decoder=h264 --enable-decoder=hevc --enable-decoder=mpeg4 --enable-decoder=aac --enable-decoder=mp3 --enable-decoder=flac --enable-decoder=pcm_s24le --enable-demuxer=h264 --enable-demuxer=hevc --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mp4 --enable-demuxer=mpegts --enable-demuxer=hls --enable-demuxer=flv --enable-demuxer=aac --enable-demuxer=mpegvideo --enable-demuxer=wav --enable-demuxer=pcm_s24le --enable-demuxer=flac --enable-parser=aac --enable-parser=aac_latm --enable-parser=mpegaudio --enable-parser=flac --enable-parser=hevc --enable-parser=h264 --enable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --disable-bsf=hevc_mp4toannexb --disable-bsf=imx_dump_header --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --disable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --disable-asm --disable-stripping --disable-optimizations --enable-cross-compile --enable-debug --enable-hwaccel=h264_videotoolbox --enable-hwaccel=hevc_videotoolbox --enable-openssl --enable-libsrt --enable-protocol=libsrt --extra-cflags='-g -arch arm64 -mios-version-min=11.0 -I/Users/dynastydream/Desktop/代码/QPlayer2--正式入职/qplayer2-demo/qplayer/dependency/libs/ios/qplayer-openssl/include -I/Users/dynastydream/Desktop/代码/QPlayer2--正式入职/qplayer2-demo/qplayer/dependency/libs/ios/qplayer-srt/include' --extra-cxxflags='-g -arch arm64 -mios-version-min=11.0 -I/Users/dynastydream/Desktop/代码/QPlayer2--正式入职/qplayer2-demo/qplayer/dependency/libs/ios/qplayer-openssl/include -I/Users/dynastydream/Desktop/代码/QPlayer2--正式入职/qplayer2-demo/qplayer/dependency/libs/ios/qplayer-srt/include' --extra-ldflags='-g -arch arm64 -mios-version-min=11.0 -L/Users/dynastydream/Desktop/代码/QPlayer2--正式入职/qplayer2-demo/qplayer/dependency/libs/ios/qplayer-openssl/lib -L/Users/dynastydream/Desktop/代码/QPlayer2--正式入职/qplayer2-demo/qplayer/dependency/libs/ios/qplayer-srt/lib' --prefix='/Users/dynastydream/Desktop/代码/QPlayer2--正式入职/qplayer2-demo/qplayer/dependency/qplayer-ffmpeg/ios-build/arm64'"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "/Users/dynastydream/Desktop/代码/QPlayer2--正式入职/qplayer2-demo/qplayer/dependency/qplayer-ffmpeg/ios-build/arm64/share/ffmpeg"
#define AVCONV_DATADIR "/Users/dynastydream/Desktop/代码/QPlayer2--正式入职/qplayer2-demo/qplayer/dependency/qplayer-ffmpeg/ios-build/arm64/share/ffmpeg"

...
HEADERS_FOLDER="${QPLAYER_FFMPEG_FOLDER}/include/libswresample"
...
cp -f ${BUILD_DIR}/Debug-iphoneos/libswresample.a ${LIB_FOLDER}/

cp -f ${BUILD_DIR}/Debug-iphoneos/include/swresample/* ${HEADERS_FOLDER}/
